...
RUN julia -e 'import Pkg; Pkg.add(name="Images", vesion="0.25.2"); using Images'
...
RUN julia -e 'import Pkg; Pkg.add(name="VectorizedRoutines", version="1.3.2"); using Rotations'
